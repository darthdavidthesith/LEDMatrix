...
class BaseNFLManager(Football):  # Renamed class
    ...
    def __init__(self, config: Dict[str, Any], display_manager, cache_manager):
        ...
        self.logger.info(
            f"Initialized NFL manager with display dimensions: {self.display_width}x{self.display_height}"
        )
    ...
    def _fetch_nfl_api_data(self, use_cache: bool = True) -> Optional[Dict]:
        ...
        if (
            ...
            return self._fetch_season_directly(
                ESPN_NFL_SCOREBOARD_URL, datestring, cache_key, f"{season_year} season"
            )
...
class NFLRecentManager(BaseNFLManager, SportsRecent):  # Renamed class
    ...
    def __init__(self, config: Dict[str, Any], display_manager, cache_manager):
        ...
        self.logger.info(
            f"Initialized NFLRecentManager with {len(self.favorite_teams)} favorite teams"
        )
...
class NFLUpcomingManager(BaseNFLManager, SportsUpcoming):  # Renamed class
    ...
    def __init__(self, config: Dict[str, Any], display_manager, cache_manager):
        ...
        self.logger.info(
            f"Initialized NFLUpcomingManager with {len(self.favorite_teams)} favorite teams"
        )
